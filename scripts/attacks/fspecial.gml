...
//set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_bite"));
...
//set_window_value(AT_FSPECIAL, 4, AG_WINDOW_SFX, sound_get("heal"));
...
//set_window_value(AT_FSPECIAL, 6, AG_WINDOW_SFX, sound_get("heal"));
...
//set_window_value(AT_FSPECIAL, 8, AG_WINDOW_HSPEED, 1);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_X, 39);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_EXTRA_HITPAUSE, 1.0);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_WIDTH, 58);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_syl_ustrong_part2"));