...
set_hitbox_value(AT_DSPECIAL, 2, HG_VISUAL_EFFECT, small_leaf_hfx);
...
set_hitbox_value(AT_DSPECIAL_AIR, 1, HG_PROJECTILE_ANIM_SPEED, 32);
...
set_hitbox_value(AT_DSPECIAL_AIR, 1, HG_PROJECTILE_HSPEED, 10);
