...
set_hitbox_value(AT_NSPECIAL, 1, HG_ANGLE, 10);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, small_leaf_hfx);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_GROUND_FRICTION, 1.75);
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("tip"));
