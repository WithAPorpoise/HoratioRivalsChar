...
set_hitbox_value(AT_UAIR, 1, HG_ANGLE, 160);
set_hitbox_value(AT_UAIR, 1, HG_BASE_KNOCKBACK, 1);
set_hitbox_value(AT_UAIR, 1, HG_KNOCKBACK_SCALING, .25);
...
set_hitbox_value(AT_UAIR, 3, HG_BASE_KNOCKBACK, 1);
...
set_hitbox_value(AT_UAIR, 3, HG_VISUAL_EFFECT, small_wood_hfx);
...
set_hitbox_value(AT_UAIR, 4, HG_HITBOX_X, 11);
set_hitbox_value(AT_UAIR, 4, HG_HITBOX_Y, -85);
set_hitbox_value(AT_UAIR, 4, HG_WIDTH, 80);
set_hitbox_value(AT_UAIR, 4, HG_HEIGHT, 50);
set_hitbox_value(AT_UAIR, 4, HG_PRIORITY, 1);
set_hitbox_value(AT_UAIR, 4, HG_DAMAGE, 5);
set_hitbox_value(AT_UAIR, 4, HG_ANGLE, 65);
set_hitbox_value(AT_UAIR, 4, HG_BASE_KNOCKBACK, 1);
set_hitbox_value(AT_UAIR, 4, HG_KNOCKBACK_SCALING, .25);
set_hitbox_value(AT_UAIR, 4, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UAIR, 4, HG_HITPAUSE_SCALING, .5);
set_hitbox_value(AT_UAIR, 4, HG_VISUAL_EFFECT, large_wood_hfx);
