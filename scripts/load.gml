...
sprite_change_offset("dashstart", 37, 79);
sprite_change_offset("dashstop", 37, 79);
sprite_change_offset("dashturn", 37, 79);

sprite_change_offset("jumpstart", 37, 69);
sprite_change_offset("jump", 37, 80);
