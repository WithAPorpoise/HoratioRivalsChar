...
sprite_change_offset("crouch", 55, 94);
sprite_change_offset("walk", 40, 94);
sprite_change_offset("walkturn", 40, 94);
sprite_change_offset("dash", 37, 109);
sprite_change_offset("dashstart", 50, 100);
sprite_change_offset("dashstop", 50, 100);
sprite_change_offset("dashturn", 42, 94);

sprite_change_offset("jumpstart", 42, 100);
sprite_change_offset("jump", 72, 132);
sprite_change_offset("doublejump", 96, 144);
sprite_change_offset("walljump", 96, 144);
sprite_change_offset("pratfall", 78, 140);
sprite_change_offset("land", 42, 100);
sprite_change_offset("landinglag", 42, 100);
...
sprite_change_offset("horatio_hurtbox", 18, 74);
...
sprite_change_offset("dattack", 50, 125);
sprite_change_offset("ftilt", 64, 126);
sprite_change_offset("dtilt", 80, 94);
sprite_change_offset("utilt", 50, 128);
...
sprite_change_offset("fspecial_air", 74, 140);
sprite_change_offset("uspecial", 74, 150);
sprite_change_offset("uspecial_air", 74, 150);
sprite_change_offset("dspecial", 50, 96);
